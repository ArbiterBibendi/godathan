...
execute_process(
  COMMAND "/usr/bin/git" show-ref 7628d844
  WORKING_DIRECTORY "/home/drake/projects/godathan/lib/sleepy-discord/deps/opus"
...
if("${show_ref_output}" MATCHES "refs/remotes/7628d844")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "7628d844")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "7628d844")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 7628d844
  WORKING_DIRECTORY "/home/drake/projects/godathan/lib/sleepy-discord/deps/opus"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://gitlab.xiph.org/xiph/opus.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/drake/projects/godathan/lib/sleepy-discord/deps/opus/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/drake/projects/godathan/lib/sleepy-discord/deps/opus/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
